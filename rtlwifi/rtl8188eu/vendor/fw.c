...
static void _rtl88e_enable_fw_download(struct ieee80211_hw *adapt, bool enable)
{
	u8 tmp;
...
static void _rtl88e_fw_block_write(struct ieee80211_hw *adapt,
...
static void _rtl88e_fw_page_write(struct ieee80211_hw *adapt,
...
static void _rtl88e_write_fw(struct ieee80211_hw *adapt, u8 *buffer, u32 size)
{
	u8 *buf_ptr = buffer;
	u32 page_no, remain;
	u32 page, offset;
...
static void rtl88e_firmware_selfreset(struct ieee80211_hw *adapt)
{
	u8 u1b_tmp;
...
static int _rtl88e_fw_free_to_go(struct ieee80211_hw *adapt)
{
	int err = -EIO;
	u32 counter = 0;
	u32 value32;
...
int rtl88eu_download_fw(struct ieee80211_hw *adapt)
{
